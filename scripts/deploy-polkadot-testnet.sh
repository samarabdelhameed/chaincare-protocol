...
# Deploy ChainCARE contracts to Polkadot Testnet
# Usage: ./deploy-polkadot-testnet.sh YOUR_MNEMONIC

set -e

MNEMONIC="$1"
ADDRESS="5HjLppYRLJ1jjRT4JHhg5FnDvPRtwxcFUvLqQ34iwGuFPayN"
...
echo "🚀 Deploying ChainCARE contracts to Polkadot Testnet..."
